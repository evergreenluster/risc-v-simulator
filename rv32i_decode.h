...
/**
 * @class rv32i_decode
 * @brief A class for decoding RISC-V RV32I instructions
 * @details Provides functionality to decode and render RISC-V instructions,
 *          including extraction of instruction fields and formatting of 
